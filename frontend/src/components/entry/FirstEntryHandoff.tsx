...
const TIPS = [
    ...
    { icon: FiStar, text: `Your memory saves after ${MIN_CHARACTERS_FOR_ENTRY_SAVE} characters. After ${MIN_WORDS_FOR_ENTRY_INSIGHTS} words, I\u2019ll uncover patterns and insights for you.` },
];
