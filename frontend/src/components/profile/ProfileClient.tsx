...
export default function ProfileClient() {
    ...
    if (!user) {
        // Redirect handled in useEffect usually, but consistent with original code
        ...
        <div className="min-h-screen p-6 md:p-12 relative z-10">
            <FadeIn className="max-w-6xl mx-auto space-y-8 mt-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                            ...
                            >
                                ...
                                <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                                    ...
                                    <div className="text-center md:text-left flex-1">
                                        <h2 className="text-4xl font-serif mb-2">{user.name || 'Anonymous User'}</h2>
                    ...
                    <StaggerContainer delay={0.2} className="lg:col-span-4 space-y-8">
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex justify-between items-end">
                                                <p className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Experience (XP)</p>
                        ...
                        <SlideUp>
                            ...
                            >
                                <h3 className="text-xl font-serif px-2">Account Settings</h3>
                                ...
                                <div className="space-y-2">
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-sm font-bold text-slate-300 tracking-wider">Theme</span>
                                        </div>
                                        <div className={`w-10 h-6 rounded-full relative transition-all duration-300 ${theme === 'dark' ? 'bg-slate-700' : 'bg-primary'}`}>
                                            <motion.div
                                                layout
                                                className={`absolute top-1 w-4 h-4 rounded-full bg-white transition-all duration-300 ${theme === 'dark' ? 'left-1' : 'left-5'}`}
                                            />
                                        </div>
                                    </motion.button>
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-sm font-bold text-slate-300 tracking-wider">Notifications</span>
                                        </div>
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <span className="text-sm font-bold text-red-400 tracking-wider">Log Out</span>
                                        </div>
