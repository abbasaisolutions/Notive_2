            ...
            <section className="grid gap-6 xl:grid-cols-[1.2fr,0.8fr]">
                <div className="bento-box p-8 space-y-6">
                    <div>
                        ...
                        <h2 className="mt-2 text-2xl font-serif text-white">Check your account before big changes</h2>
                    ...
                    <div className="rounded-[1.6rem] border border-white/10 bg-black/20 p-5 space-y-4">
                        <div className="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                <p className="text-sm font-semibold text-white">Locked actions</p>
                ...
                <section className="bento-box p-6 space-y-4">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            <h3 className="text-xl font-serif text-white">Why this matters</h3>
                            <p className="mt-2 text-sm text-ink-secondary">
                ...
                <div className="bento-box p-8 space-y-6">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <h3 className="mt-2 text-xl font-serif text-white">Change your sign-in email</h3>
                            <p className="mt-2 text-sm text-ink-secondary">
            ...
            <section id="delete-account" className="bento-box p-8 space-y-6 border-white/12 bg-[linear-gradient(135deg,rgba(20,27,45,0.94),rgba(13,18,34,0.92))]">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <h3 className="mt-2 text-xl font-serif text-white">Delete your account</h3>
                        <p className="mt-2 text-sm text-ink-secondary">
