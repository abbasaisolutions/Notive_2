...
export default function DailyPathCard({ eyebrow, title, body, reason, href, cta }: DailyPathCardProps) {
    return (
        <section className="rounded-card-125 border border-[rgba(138,154,111,0.26)] bg-[rgba(138,154,111,0.1)] p-3.5">
            <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-2 text-[0.78rem] leading-5 text-[rgb(var(--text-soft))]">{body}</p>
